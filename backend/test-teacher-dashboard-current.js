...
// Test teacher login with current credentials
      ...
      if (loginResult.success && loginResult.token) {
        ...
        const dashboardReq = http.request(dashboardOptions, (dashboardRes) => {
          ...
          dashboardRes.on('end', () => {
            ...
            // Also test teacher subjects endpoint
            ...
            const subjectsReq = http.request(subjectsOptions, (subjectsRes) => {
              console.log('Teacher Subjects Status:', subjectsRes.statusCode);
              
              let subjectsData = '';
              subjectsRes.on('data', (chunk) => {
                subjectsData += chunk;
              });
              
              subjectsRes.on('end', () => {
                console.log('Teacher Subjects Response:', subjectsData);
              });
            });
