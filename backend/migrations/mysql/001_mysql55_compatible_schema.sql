-- ============================================================================
-- KPT Student Portal - MySQL 5.5 Compatible Schema
-- ============================================================================
-- This file matches the table/column names used by the PHP API in `backend/php/`,
-- but avoids MySQL 5.5 limitations:
-- - Only ONE TIMESTAMP column per table can use CURRENT_TIMESTAMP in DEFAULT/ON UPDATE
-- - DATETIME cannot DEFAULT to CURRENT_TIMESTAMP in MySQL 5.5
-- - utf8mb4 index length limits (use email(191) for UNIQUE indexes)
...
CREATE TABLE IF NOT EXISTS users (
  ...
  clerk_user_id VARCHAR(191) DEFAULT NULL,
  created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at TIMESTAMP NULL DEFAULT NULL,
  PRIMARY KEY (id),
  UNIQUE KEY uq_users_email (email(191)),
  UNIQUE KEY uq_users_clerk_user_id (clerk_user_id)
...
CREATE TABLE IF NOT EXISTS profiles (
  ...
  updated_at TIMESTAMP NULL DEFAULT NULL,
  PRIMARY KEY (id),
  UNIQUE KEY uq_profiles_email (email(191)),
